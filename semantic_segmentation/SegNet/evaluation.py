...
def main(options):
    ...
    model = VGG16(input_bands = options['input_channels'],
...
if __name__ == "__main__":
    ...
    # Unet model path
    parser.add_argument('--model_path', default=os.path.join(up(os.path.abspath(__file__)), '../VGG/trained_models', '44', 'model.pth'), help='Path to Unet pytorch model')
