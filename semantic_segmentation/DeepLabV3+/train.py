...
logging.basicConfig(filename=os.path.join(root_path, 'logs','log_DeeplabV3Plus.log'), filemode='a',level=logging.INFO, format='%(name)s - %(levelname)s - %(message)s')
logging.info('*'*10)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--checkpoint_path', default='/home/henry/Documents/marine-debris/semantic_segmentation/DeepLabV3+/trained_models', help='folder to save checkpoints into (empty = this folder)')
