...
logging.basicConfig(filename=os.path.join(root_path, 'logs','evaluating_deeplab.log'), filemode='a',level=logging.INFO, format='%(name)s - %(levelname)s - %(message)s')
logging.info('*'*10)
...
if __name__ == "__main__":
    ...
    # Unet model path
    parser.add_argument('--model_path', default=os.path.join(up(os.path.abspath(__file__)), '../DeepLabV3+/trained_models', '44', 'model.pth'), help='Path to DeepLab pytorch model')
